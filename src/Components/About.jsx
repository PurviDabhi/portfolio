            ...
            <div className="min-h-screen" id="about">
                ...
                <div className="flex justify-around lg:flex-row flex-col mt-10 gap-8 lg:px-12 md:px-8 " >
                    ...
                    <div className="mt-6" data-aos="fade-up" data-aos-delay="50">
                        ...
                        <a href="Purvi_Dabhi.pdf" className="text-xl bg-blue-600 text-white rounded-md  py-2 my-3 block max-w-[15rem] text-center mx-auto lg:mx-0 hover:scale-95 duration-300">Download CV</a>
                    </div>
                </div>
            </div>
        </>
